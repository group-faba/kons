...
# ——— 1) Прочитать сервисный ключ из ENV
...
# ——— 2) Инициализировать Google Credentials
creds = Credentials.from_service_account_info(creds_dict, scopes=SCOPES)

# ——— 3) Подключиться к Drive и Sheets
...
# ——— Healthcheck чтобы Render не "засыпал"
...
# ——— Получить список экспертов для приложения
