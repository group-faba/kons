...
REDIRECT_URI = os.getenv('REDIRECT_URI')    # https://<ваш>.onrender.com/oauth2callback
APP_URL      = os.getenv('APP_URL')         # https://<ваш>.onrender.com
...
# Записываем client_secrets.json
if GOOGLE_JSON:
